...
export default function ChapterHeader({
  ...
  return (
    <header className="mb-14 md:mb-20 max-w-3xl">
      ...
      <p className="font-mono text-sm text-muted mb-4">Chapter {chapterNumber}</p>
      <h1 className="font-disp text-display-lg md:text-display-xl font-extrabold leading-[0.9] text-ink mb-8">
        {title}
      </h1>
