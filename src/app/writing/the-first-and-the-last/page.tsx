...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    authors: ["Josh Kelsey"],
    images: [{ url: "/site-images/airplane-window.jpg", width: 1600, height: 900, alt: "A view of the horizon through an airplane window" }],
  },
  twitter: {
    ...
    description:
      "One ran 1:59:30. The other ran 12:16:00. On finishing, faith, and the race called life.",
    images: ["/site-images/airplane-window.jpg"],
  },
};
...
export default function Post() {
  return (
    <EssayLayout
      ...
      kicker={<>Essay <span className="flare">/</span> 8 min read</>}
      titleLead="The First and the "
      titleAccent="Last."
      standfirst="One ran 1:59:30. The other ran 12:16:00. On finishing, faith, and the race called life."
      leadImage="/site-images/airplane-window.jpg"
      leadAlt="A view of the horizon through an airplane window"
      description={DESCRIPTION}
      datePublished="2026-04-29"
      dateModified="2026-05-01"
      wordCount={1900}
      keywords={["London Marathon", "Sabastian Sawe", "Clair Roberts", "Hebrews 12", "tetelestai", "perseverance", "Josh Kelsey"]}
    >
