...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    authors: ["Josh Kelsey"],
    images: [{ url: "/site-images/nyc-williamsburg-bridge.jpg", width: 1600, height: 900, alt: "The Williamsburg Bridge over the East River" }],
  },
  twitter: {
    ...
    description:
      "Reflections on pastoring, planting, and loving New York City for thirteen years.",
    images: ["/site-images/nyc-williamsburg-bridge.jpg"],
  },
};
...
export default function Post() {
  return (
    <EssayLayout
      ...
      kicker={<>Essay <span className="flare">/</span> 9 min read</>}
      titleLead="Thirteen years in New York "
      titleAccent="City."
      standfirst="Reflections on pastoring, planting, and loving New York City for thirteen years."
      leadImage="/site-images/nyc-williamsburg-bridge.jpg"
      leadAlt="The Williamsburg Bridge over the East River"
      description="Pastor Josh Kelsey reflects on thirteen years of pastoring, planting, and loving New York City, what FOUNT Church NYC has taught him about ministry in the city that doesn't love back easily."
      datePublished="2026-03-15"
      dateModified="2026-03-15"
      wordCount={1100}
      keywords={["church planting", "New York City", "FOUNT Church NYC", "pastoring", "local church", "Josh Kelsey"]}
    >
