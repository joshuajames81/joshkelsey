...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://joshkelsey.com/writing/on-preaching-the-whole-text" },
  openGraph: {
...
const articleSchema = {
  ...
  mainEntityOfPage: "https://joshkelsey.com/writing/on-preaching-the-whole-text",
};
