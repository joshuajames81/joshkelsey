...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    authors: ["Josh Kelsey"],
    images: [{ url: "/site-images/bible-silhouettes.jpg", width: 1600, height: 900, alt: "Silhouetted figures against soft light" }],
  },
  twitter: {
    ...
    description:
      "Preaching isn't about style. It's about whose voice is supposed to be loudest in the room.",
    images: ["/site-images/bible-silhouettes.jpg"],
  },
};
...
export default function Post() {
  return (
    <EssayLayout
      ...
      titleLead="On preaching the whole "
      titleAccent="text."
      standfirst="Preaching isn't about style. It's about whose voice is supposed to be loudest in the room."
      leadImage="/site-images/bible-silhouettes.jpg"
      leadAlt="Silhouetted figures against soft light"
      description="Pastor Josh Kelsey on faithful preaching. Why the real question isn't style, it's whose voice is supposed to be loudest in the room."
      datePublished="2026-02-10"
      dateModified="2026-02-10"
      wordCount={900}
      keywords={["expository preaching", "faithful preaching", "biblical text", "Greek and Hebrew", "FOUNT Church NYC", "Josh Kelsey"]}
    >
