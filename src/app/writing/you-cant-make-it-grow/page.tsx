...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "On auxin, a verb Paul used, and the one thing none of us can actually do.",
    type: "article",
    url: "https://joshkelsey.org/writing/you-cant-make-it-grow",
    publishedTime: "2026-05-20",
    modifiedTime: "2026-05-20",
    authors: ["Josh Kelsey"],
    images: [{ url: "/site-images/land-regrowth.jpg", width: 1600, height: 900, alt: "New growth returning to cleared land" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "You Can't Make It Grow | Josh Kelsey",
    description: "On auxin, a verb Paul used, and the one thing none of us can actually do.",
    images: ["/site-images/land-regrowth.jpg"],
  },
};
...
export default function Post() {
  return (
    <EssayLayout
      ...
      titleLead="You Can't Make It "
      titleAccent="Grow."
      standfirst="On auxin, a verb Paul used, and the one thing none of us can actually do."
      leadImage="/site-images/land-regrowth.jpg"
      leadAlt="New growth returning to cleared land"
      description={DESCRIPTION}
      datePublished="2026-05-20"
      wordCount={1100}
      keywords={["auxin", "auxanō", "1 Corinthians 3", "Christian leadership", "spiritual growth", "Josh Kelsey"]}
    >
      <blockquote className="mb-12 md:mb-16 border-l-2 border-flare pl-6 font-serif italic text-xl text-fg/75 leading-snug">
        &ldquo;I have great faith in a seed. Convince me that you have a seed there, and I am
        prepared to expect wonders.&rdquo;
        <footer className="mt-3 text-sm not-italic font-mono text-dim">
          Henry David Thoreau, <cite className="not-italic">Faith in a Seed</cite>
        </footer>
      </blockquote>

      <div className="font-serif leading-[1.75] space-y-6">
        ...
        <blockquote className="border-l-2 border-flare pl-6 italic my-8 text-fg/80">
        ...
        <p className="font-disp font-black text-2xl md:text-3xl text-fg not-italic">
          Get some sleep.
        </p>

        <p className="text-sm font-mono text-fg/65 leading-relaxed border-t border-line pt-8 mt-12">
